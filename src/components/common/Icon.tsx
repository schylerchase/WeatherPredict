...
// Map layer icons
export function RadarIcon({ className, size = 20 }: SvgIconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function SatelliteIcon({ className, size = 20 }: SvgIconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ThermometerIcon({ className, size = 20 }: SvgIconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function CloudRainIcon({ className, size = 20 }: SvgIconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function WindIcon({ className, size = 20 }: SvgIconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function CloudIcon({ className, size = 20 }: SvgIconProps) {
  return (
    <svg
      width={size}
      height={size}
